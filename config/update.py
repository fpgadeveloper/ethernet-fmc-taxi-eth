...
def create_tables(data):
    ...
    for group in used_groups:
        ...
        tables.append('')
        tables.append('| Target board          | Target design      | Ports       | FMC Slot(s) | Standalone<br> Echo Server | Yocto | Vivado<br> Edition |')
        tables.append('|-----------------------|--------------------|-------------|-------------|-------|-------|-------|')
        for design in data['designs']:
            if not design['publish']:
                continue
...
# lanes list to it as the set of Ethernet FMC ports to instantiate.
