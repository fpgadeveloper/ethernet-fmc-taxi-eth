...
The documentation for these example designs is hosted at
<https://docs.opsero.com/projects/ethernet-fmc-taxi-eth/> and it is best viewed from there.
...
The pages are Jinja2 templates rendered against `config/data.json` (the target design tables
are generated from it), so add or change a target design in `data.json`, not in the pages.
...
only wish to view the documentation, then please view it
[here](https://docs.opsero.com/projects/ethernet-fmc-taxi-eth/).
